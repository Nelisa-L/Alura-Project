...
agent_cloud.py
---------------
Versión del motor RAG pensada para DESPLIEGUE EN LA NUBE (Render, etc.),
donde no es viable correr Ollama (requiere varios GB de RAM que los
tiers gratuitos no ofrecen).

En su lugar, usa la API gratuita de Groq (https://console.groq.com) para
la generación de respuestas — misma lógica RAG, mismo índice vectorial,
solo cambia el motor de generación de texto.
